...
class ArrayCQueue implements Queue{
	...
	public void enQueue(char item) {
		if(isFull()) {
			System.out.println("Inserting fail! Array Circular is Full!");
		} 
		else {
	...
	public char deQueue() {
		if(isEmpty()) {
			System.out.println("Deleting fail! Array Circular is empty!");
			return 0;
			} 
		else {
	...
	public char peek() {
		if(isEmpty()) {
			System.out.println("Peeking fail Array Circular is empty!");
			return 0;
		}
		else
	...
	public void printQueue() {
		if(isEmpty()) 
			System.out.println( "Array Circular is empty!!");
		else {
